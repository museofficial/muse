...
ALTER TABLE "new_KeyValueCaches" RENAME TO "KeyValueCaches";
...
CREATE INDEX "shortcuts_shortcut" ON "Shortcuts"("shortcut");
CREATE INDEX "shortcuts_guild_id" ON "Shortcuts"("guildId");
...
ALTER TABLE "new_FileCaches" RENAME TO "FileCaches";

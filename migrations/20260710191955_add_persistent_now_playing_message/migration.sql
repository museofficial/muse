...
CREATE TABLE "new_Setting" (
    ...
    "persistentNowPlayingMessage" BOOLEAN NOT NULL DEFAULT false,
...
INSERT INTO "new_Setting" ("autoAnnounceNextSong", "createdAt", "defaultQueuePageSize", "defaultVolume", "guildId", "leaveIfNoListeners", "playlistLimit", "queueAddResponseEphemeral", "secondsToWaitAfterQueueEmpties", "turnDownVolumeWhenPeopleSpeak", "turnDownVolumeWhenPeopleSpeakTarget", "updatedAt") SELECT "autoAnnounceNextSong", "createdAt", "defaultQueuePageSize", "defaultVolume", "guildId", "leaveIfNoListeners", "playlistLimit", "queueAddResponseEphemeral", "secondsToWaitAfterQueueEmpties", "turnDownVolumeWhenPeopleSpeak", "turnDownVolumeWhenPeopleSpeakTarget", "updatedAt" FROM "Setting";
DROP TABLE "Setting";
